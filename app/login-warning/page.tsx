   ...
   <div className="bg-white100">
        <div className="container mx-auto grid grid-cols-2 gap-8 py-20">
            <div className="col-span-2 lg:col-span-1">
                <div className="">
                <div className="flex items-center gap-2 mb-2 border-b-2 border-b-secondary700 border-dashed pb-4">
                    <Image
                        src={FiCheckCircle  }
                        ...
                        width={24}
                        />
                    <span className="text-dark text-3xl font-blod">برای ادامه فرآیند لطفا وارد سایت شوید</span>
                </div> 
                <span className="text-dark text-base">دسترسی مادام العمر</span>
                <p className="text-secondary text-sm">برای دسترسی دائمی به دوره ها و پشتیبانی لازم است به اکانت کاربری خود وارد شوید. برای دسترسی دائمی به دوره ها و پشتیبانی لازم است به اکانت کاربری خود وارد شوید. </p>
                </div>
            </div>
            <div className="col-span-2 lg:col-span-1">
                <div className="bg-white rounded-2xl px-4 py-8 flex flex-col items-center justify-center lg:max-w-[450px] mx-auto border border-did/10">
