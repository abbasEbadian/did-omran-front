                ...
                <div className="flex items-center justify-center gap-5">
                    ...
                    <div className="flex items-center gap-3 flex-col">
                        <div className="flex items-center gap-4 ">
                            <div
                                className="flex items-center gap-1 border-e-2 border-e-secondary700 border-dashed py-2">
                                <Image
                        ...
                        <div className="flex items-center justify-between gap-4">
                            ...
                            <Link href="#"
                                  className="text-white bg-secondary800 rounded-2xl text-sm px-8 py-2 flex gap-1 items-center">
                                مشاهده و رزرو
                                <Image
                                    src={"/icons/chevron-small-left.svg"}
                                    alt="User Check Img"
                                    width={24}
                                    height={24}/>
                            </Link>
