...
function AdvantagesEvents() {
  return (
    ...
    <div className="flex items-center justify-center gap-1">
        <span className="text-xl text-dark font-extrabold">مزایای شرکت در رویداد های  </span>
        <Link href="#" className="text-did font-black text-xl">دیدعمران</Link>
    </div>
    <div className="flex lg:flex-row flex-col items-center justify-center gap-20 my-12">
        <div className="flex flex-col items-center gap-4">
            ...
            <span className="text-secondary text-xl font-black"> نکات طلایی </span>
        </div>
        <div className="flex flex-col items-center gap-4">
            ...
            <span className="text-secondary text-xl font-black">کارنامه کامل</span>
        </div>
        <div className="flex flex-col items-center gap-4">
            ...
            <span className="text-secondary text-xl font-black">اساتید با تجربه</span>
        </div>
        <div className="flex flex-col items-center gap-4">
            ...
            <span className="text-secondary text-xl font-black">کسب مهارت</span>
        </div>
    </div>
    </>
  )
