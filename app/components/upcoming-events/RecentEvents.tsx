    ...
    return (
        <>
            <div className="container mx-auto my-32">
                ...
                <p className="text-secondary text-sm text-center">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت
                    چاپ</p>
                <div className="grid grid-cols-4 gap-9 mt-24">
                    <div className="col-span-1">
                        <div className="bg-did700 rounded-2xl px-2 pb-11 pt-24 relative">
                            ...
                            <div
                                className="flex items-center justify-center gap-2 border-b-2 border-b-white border-dashed flex-col pb-6 w-4/5 mx-auto">
                            ...
                            <div className="flex flex-col items-center justify-center gap-3 mt-2">
                                ...
                                <Link href="#"
                                      className="text-white bg-did px-4 py-2 rounded-2xl text-xs shadow-custom-drop-shadow">مشاهده
                                    رویداد</Link>
                            </div>
                        </div>
                    </div>
