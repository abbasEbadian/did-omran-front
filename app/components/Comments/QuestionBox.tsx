...
function QuestionBox() {
  return (
    <>
    <div className="flex flex-col bg-secondary700/40 rounded-2xl lg:px-16 px-4 py-8 container mx-auto my-36 gap-16">
            ...
            <div className="flex items-center gap-4 lg:flex-row  flex-col">
                <div className="flex flex-col gap-3 items-center justify-center">
                    <Image
                        ...
                        <Link href="#" className="text-white bg-did rounded-2xl text-sm px-6 py-2 flex gap-1 items-center whitespace-nowrap">
