...
function AddComments() {
  return (
    ...
    <div className="bg-did/10 px-4  py-7 rounded-2xl shadow-md max-w-md mx-auto">
      <span className="text-3xl font-medium text-secondary mb-8 text-center block mx-auto">ثبت نظر</span>
      ...
      <form>
        ...
        <div className="flex items-center gap-1 mt-2">
            <Image
                ...
                width={20}
                height={24} />
            <Link href="#" className="text-secondary  text-sm rounded-2xl">ورود به عنوان دانشجو</Link>
        </div>
    </div>
    </>
  )
