...
function InstructorInfo() {
  return (
    <>
    <div className="flex lg:flex-row flex-col items-center justify-center gap-12  bg-did/5 rounded-2xl px-8 mx-4 lg:mx-4 py-8 my-24" id='InstructorInfo'>
        <div className="flex items-center gap-4">
            <div className="w-full">
                <Image
                    ...
                    height={250} 
                    width={250}
                    className="object-cover w-full lg:min-w-64 lg:min-h-64"
                    />
            </div>
