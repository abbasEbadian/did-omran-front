    ...
    return (
        <div className="relative my-12">
            ...
            <div className="lg:relative lg:my-56 lg:py-28 lg:me-40 overflow-hidden">
                ...
                <div className="lg:absolute lg:block hidden inset-0 bg-gradient-to-r from-[#9996fa6c] from-30% via-[#0578B9] via-90% to-[#0578B9] to-90% transform skew-y-3 origin-top-left"></div>
                {/* محتوای متن */}
                    ...
                    <div className="lg:col-span-5 col-span-8">
                        <div className="lg:ms-10 lg:ps-6 px-4 flex flex-col lg:items-start items-center">
                            ...
                            <p className="text-base text-secondary mb-6 leading-relaxed font-medium text-justify">
                                خدمات کتابخانه مجازی آنلاین موسسه دیدعمران شامل
                                تمامی آیین‌نامه داخلی (مباحث 22 گانه، راهنمای
                                جوش، استاندارد 2800 و ...) و آیین‌نامه‌های
                                بین‌المللی (ASCE7, ACI, AISC, JSCE, …) و
                                نشریه‌های داخلی و خارجی (نشریه 543، IBS، FEMA و
                                ...) است. تمامی مهندسین عمران و پژوهشگران در
                                سراسر کشور این امکان را دارند تا از این کتابخانه
                                در راستای آمادگی آزمون‌های نظام مهندسی
                                نظارت-اجراء-محاسبات عمران، یادگیری و فعالیت
                                پژوهشی خود استفاده نمایند.
                            </p>
                            <Link
                                href="/books"
