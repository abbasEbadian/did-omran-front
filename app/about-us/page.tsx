...
type ContactUsFormType = SendContactProps & { error: string }

function ContactUsPage() {
    const [data, setData] = useState<ContactUsFormType>({
        email: "",
        name: "",
        message: "",
        error: "",
    ...
    const changeData = (key: keyof ContactUsFormType, value: string) => {
        setData(prev => ({
            ...prev,
            [key]: value
        }));
    ...
    return (
        <>
            ...
            <div
                className="bg-white rounded-2xl container mx-auto  px-11 pb-14 shadow-[20px_20px_30px_0px_rgba(102,106,245,0.13)] pt-6">
                    ...
                    <div className="col-span-2 lg:col-span-1">
                        <div className="flex flex-col gap-4 items-center lg:items-start">
                            ...
                            <p className="text-sm text-secondary text-justify">
                                ...
                                دارد که فارغ التحصیلان دانشگاهی به ویژه مهندسین عمران و معماری را سردرگم کرده است. ما در
                                دید عمران این خلل‌ها را برطرف کرده و تا ورود شما به بازار کار حرفه‌ای مهندسی در کنارتان
                                هستیم. آنچه در دید عمران بدست‌ می‌آورید دیدگاه و تخصص مهندسی است؛ نه صرفا یک پروانه
                                مهندسی!
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col gap-8">
                    <div
                        className="border-dashed border-b-2 border-b-secondary700 pb-3 flex flex-col items-start gap-2">
